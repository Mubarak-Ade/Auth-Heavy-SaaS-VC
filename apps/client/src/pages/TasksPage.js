...
export function TasksPage() {
    ...
    return (_jsxs("section", { className: "stack", children: [_jsxs("div", { children: [_jsx("h2", { children: "Tasks" }), _jsx("p", { className: "muted", children: "Track assignments, priorities, and progress." })] }), _jsxs("div", { className: "card filters-grid", children: [_jsxs("label", { className: "field", children: [_jsx("span", { children: "Search" }), _jsx("input", { value: search, onChange: (event) => setSearch(event.target.value), placeholder: "Search tasks" })] }), _jsxs("label", { className: "field", children: [_jsx("span", { children: "Status" }), _jsxs("select", { value: statusFilter, onChange: (event) => setStatusFilter(event.target.value), children: [_jsx("option", { value: "all", children: "All" }), _jsx("option", { value: "todo", children: "Todo" }), _jsx("option", { value: "in_progress", children: "In progress" }), _jsx("option", { value: "done", children: "Done" })] })] }), _jsxs("label", { className: "field", children: [_jsx("span", { children: "Sort" }), _jsxs("select", { value: sortBy, onChange: (event) => setSortBy(event.target.value), children: [_jsx("option", { value: "newest", children: "Newest" }), _jsx("option", { value: "priority", children: "Priority" }), _jsx("option", { value: "status", children: "Status" })] })] })] }), _jsxs("form", { className: "card stack", onSubmit: handleCreateSubmit(handleCreateTask), children: [_jsxs("label", { className: "field", children: [_jsx("span", { children: "Task title" }), _jsx("input", { ...registerCreate("title") }), createErrors.title ? _jsx("p", { className: "error-text", children: createErrors.title.message }) : null] }), _jsxs("label", { className: "field", children: [_jsx("span", { children: "Description" }), _jsx("input", { ...registerCreate("description") }), createErrors.description ? _jsx("p", { className: "error-text", children: createErrors.description.message }) : null] }), _jsxs("label", { className: "field", children: [_jsx("span", { children: "Priority" }), _jsxs("select", { ...registerCreate("priority"), children: [_jsx("option", { value: "low", children: "Low" }), _jsx("option", { value: "medium", children: "Medium" }), _jsx("option", { value: "high", children: "High" })] })] }), _jsx("button", { type: "submit", disabled: createTaskMutation.isPending, children: createTaskMutation.isPending ? "Saving..." : "Create task" })] }), tasksQuery.isLoading ? _jsx("div", { className: "card", children: "Loading tasks..." }) : null, tasksQuery.isError ? _jsx("div", { className: "card error-text", children: "Could not load tasks right now." }) : null, _jsxs("div", { className: "stack", children: [filteredTasks.map((task) => (_jsx("article", { className: "card stack", children: editingTaskId === task.id ? (_jsxs("form", { className: "stack", onSubmit: handleEditSubmit(handleUpdateTask), children: [_jsxs("label", { className: "field", children: [_jsx("span", { children: "Title" }), _jsx("input", { ...registerEdit("title") }), editErrors.title ? _jsx("p", { className: "error-text", children: editErrors.title.message }) : null] }), _jsxs("label", { className: "field", children: [_jsx("span", { children: "Description" }), _jsx("textarea", { ...registerEdit("description"), rows: 4 }), editErrors.description ? _jsx("p", { className: "error-text", children: editErrors.description.message }) : null] }), _jsxs("div", { className: "row", children: [_jsxs("label", { className: "field", children: [_jsx("span", { children: "Priority" }), _jsxs("select", { ...registerEdit("priority"), children: [_jsx("option", { value: "low", children: "Low" }), _jsx("option", { value: "medium", children: "Medium" }), _jsx("option", { value: "high", children: "High" })] })] }), _jsxs("label", { className: "field", children: [_jsx("span", { children: "Status" }), _jsxs("select", { ...registerEdit("status"), children: [_jsx("option", { value: "todo", children: "Todo" }), _jsx("option", { value: "in_progress", children: "In progress" }), _jsx("option", { value: "done", children: "Done" })] })] })] }), _jsxs("div", { className: "row", children: [_jsx("button", { type: "submit", children: "Save changes" }), _jsx("button", { type: "button", onClick: () => { setEditingTaskId(null); resetEditForm(); }, children: "Cancel" })] })] })) : (_jsxs(_Fragment, { children: [_jsxs("div", { children: [_jsx("h3", { children: task.title }), _jsx("p", { className: "muted", children: task.description || "No description" })] }), _jsxs("p", { children: ["Status: ", _jsx("strong", { children: task.status }), " | Priority: ", _jsx("strong", { children: task.priority })] }), _jsxs("div", { className: "row", children: [_jsx("button", { type: "button", onClick: () => startEditing(task), children: "Edit" }), _jsx("button", { type: "button", onClick: () => void updateTaskMutation
                                                .mutateAsync({
                                                taskId: task.id,
